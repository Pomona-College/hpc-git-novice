...
```bash
$ git clone git@github.com:cecil/planets.git ~/Desktop/cecil-planets
```

Replace 'cecil' with the Owner's username.

If you choose to clone without the clone path
(`~/Desktop/cecil-planets`) specified at the end,
