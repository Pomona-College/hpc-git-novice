...
## Make Citation Easy for Your Users

If someone wants to cite your code in their paper, they should be able to find a `CITATION` file and copy-paste the citation. This increases the chances they'll actually cite you. Consider including both plain text and BibTeX formats to accommodate different workflows. Getting proper citation credit is important for academic careers.
