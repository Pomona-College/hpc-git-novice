...
1. **Storage quota** — GitHub's free LFS quota is 1 GB storage and 1 GB/month bandwidth per account. For larger genomics or imaging datasets, prefer Sagehen storage (`/bigdata/labname`) plus a small GitHub repo with code and metadata.
