...
The most important rule: never commit sensitive files like passwords, API keys, or private data. Always create a `.gitignore` to exclude these files before they accidentally get tracked. Once a file is committed to Git history, it's very difficult to remove completely. Prevention is much easier than remediation.
